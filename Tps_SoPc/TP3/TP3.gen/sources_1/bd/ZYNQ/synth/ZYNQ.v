...
(* CORE_GENERATION_INFO = "ZYNQ,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ZYNQ,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=3,da_bram_cntlr_cnt=2,da_ps7_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ZYNQ.hwdef" *) 
module ZYNQ
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  assign Buttons_GPIO_TRI_I = btns_4bits_tri_i[3:0];
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > ZYNQ axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ZYNQ_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  ZYNQ_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
  ...
  (* BMM_INFO_PROCESSOR = "arm > ZYNQ axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  ZYNQ_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
